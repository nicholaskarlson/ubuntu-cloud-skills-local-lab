...
any live VPS automation is added.
"""
...
class TestBook2Scaffold(unittest.TestCase):
    ...
    def test_readme_links_book2_scaffold(self) -> None:
        ...
        self.assertIn("Book 2 planning scaffold", readme)
    ...
    def test_book2_docs_keep_safety_boundary_before_automation(self) -> None:
        ...
        combined = "\n".join([companion, boundary, checklist]).lower()
    ...
    def test_repo_map_lists_book2_scaffold(self) -> None:
        ...
        self.assertIn("Book 2 planning scaffold", output)
    ...
    def test_series_status_says_book2_is_scaffolded_not_automated(self) -> None:
        output = subprocess.check_output(
            ["bash", "scripts/repo_map.sh", "--series-status"],
            cwd=ROOT,
            text=True,
        )
        self.assertIn("Book 2 — Your First Ubuntu Cloud Server", output)
        self.assertIn("Status: planning scaffold added", output)
        self.assertIn("No live VPS automation yet", output)
